package com.bridgrlabz.javaproject;
...
public class Address_Book_System {
	...
	public void addPerson() {
		...
		Contacts contact = new Contact(firstName, lastName, address, city, zipcode, state, phoneNo, email);
	...
	public static void main(String[] args) {
		...
		Address_Book_System address = new Address_Book_System();
		address.addPerson();
